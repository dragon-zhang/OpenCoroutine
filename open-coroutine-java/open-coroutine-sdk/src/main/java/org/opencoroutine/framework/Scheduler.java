 ...
 */
public class Scheduler extends NativeLibraryLoader {
     ...
     * @param mode 事件类型
     */
    public static void startScheduler(int mode) {
        SchedulerApi.startScheduler(mode);
    }
    ...
    public static boolean isScheduling() {
        return SchedulerApi.isScheduling();
    }
     ...
     */
    public static void clean(int size) {
        SchedulerApi.clean(size);
    }
}
